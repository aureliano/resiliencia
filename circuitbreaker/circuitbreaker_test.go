...
func TestNew(t *testing.T) {
	...
	assert.Equal(t, 0, p.ThresholdErrors)
...
func TestRunValidatePolicyThresholdErrors(t *testing.T) {
	...
	assert.ErrorIs(t, err, circuitbreaker.ErrThresholdValidation)
}
...
func TestRunValidatePolicyResetTimeout(t *testing.T) {
	...
	assert.ErrorIs(t, err, circuitbreaker.ErrResetTimeoutValidation)
}
...
func TestRunValidatePolicyCommand(t *testing.T) {
	...
	assert.ErrorIs(t, err, circuitbreaker.ErrCommandRequired)
}
...
func TestRunCommandCircuitHalfOpenSetToClosed(t *testing.T) {
	...
	state, _ = circuitbreaker.State(p)
	assert.EqualValues(t, circuitbreaker.OpenState, state)
...
func TestRunCommandCircuitHalfOpenSetToOpen(t *testing.T) {
	errTest := errors.New("err test")
